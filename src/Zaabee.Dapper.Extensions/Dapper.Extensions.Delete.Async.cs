...
{
    public static Task<int> DeleteByEntityAsync<T>(
    ...
    public static Task<int> DeleteByEntityAsync(
        this IDbConnection connection,
    ...
    public static Task<int> DeleteByIdAsync<T>(
        this IDbConnection connection,
        object id,
        IDbTransaction? transaction = null,
        int? commandTimeout = null,
    ...
    public static Task<int> DeleteByIdAsync(
        this IDbConnection connection,
        object id,
        Type type,
        IDbTransaction? transaction = null,
    ...
    public static Task<int> DeleteByEntitiesAsync<T>(
        this IDbConnection connection,
        IList<T> persistentObjects,
        IDbTransaction? transaction = null,
        int? commandTimeout = null,
        CommandType? commandType = null
    )
    {
        var adapter = GetSqlAdapter(connection);
        return connection.ExecuteAsync(
            adapter.GetDeleteSql(typeof(T), CriteriaType.MultiId),
            persistentObjects,
            transaction,
            commandTimeout,
            commandType
    ...
    public static Task<int> DeleteByIdsAsync<T>(
        this IDbConnection connection,
        object ids,
        IDbTransaction? transaction = null,
        int? commandTimeout = null,
    ...
    )
    {
        var adapter = GetSqlAdapter(connection);
        return connection.ExecuteAsync(
            adapter.GetDeleteSql(typeof(T), CriteriaType.None),
            null,
            transaction,
            commandTimeout,
            commandType
