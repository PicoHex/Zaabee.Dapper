...
{
    public static int DeleteByEntity<T>(
    ...
    public static int DeleteByEntity(
        this IDbConnection connection,
    ...
    public static int DeleteById<T>(
        this IDbConnection connection,
        object id,
        IDbTransaction? transaction = null,
        int? commandTimeout = null,
    ...
    public static int DeleteByEntities<T>(
        this IDbConnection connection,
    ...
    public static int DeleteByEntities(
        this IDbConnection connection,
        IEnumerable persistentObjects,
        Type type,
        IDbTransaction? transaction = null,
    ...
    public static int DeleteByIds<T>(
        this IDbConnection connection,
        IEnumerable ids,
        IDbTransaction? transaction = null,
        int? commandTimeout = null,
    ...
    )
    {
        var adapter = GetSqlAdapter(connection);
        return connection.Execute(
            adapter.GetDeleteSql(type, CriteriaType.MultiId),
            new { Ids = ids },
            transaction,
            commandTimeout,
            commandType
    ...
    )
    {
        var adapter = GetSqlAdapter(connection);
        return connection.Execute(
            adapter.GetDeleteSql(type, CriteriaType.None),
            null,
            transaction,
            commandTimeout,
            commandType
